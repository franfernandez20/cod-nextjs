export default function handler(req, res) {
  ...
  const XSRF_TOKEN =
    "mNrrbszEi8ZWd3VE4Svp1a2Y88P_9D8jUReL6Napr5YuoNYcsiqi8NI0QVTbGSuL";
  ...
  fetch(
    `https://my.callofduty.com/api/papi-client/stats/cod/v1/title/mw/platform/psn/gamer/${userid}/profile/friends/type/mp`,
    requestOptions
  )
    // .then((response) => response.text())
