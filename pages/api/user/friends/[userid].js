...
export default function handler(req, res) {
  ...
  const url = `https://my.callofduty.com/api/papi-client/stats/cod/v1/title/mw/platform/psn/gamer/${encodeduser}/profile/friends/type/mp`;
  console.log('url', url)

  fetch(
    `https://my.callofduty.com/api/papi-client/stats/cod/v1/title/mw/platform/psn/gamer/${encodeduser}/profile/friends/type/mp`,
    requestOptions
  )
