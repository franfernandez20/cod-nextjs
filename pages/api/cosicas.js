export default function handler(req, res) {
    // const XSRF_TOKEN = 'Kgah6UUIzBY8hFINOGM2MMUMffGdhELv6-lWlb96b5vWl0b1L6JghmsJIDdp4gRE'
    const XSRF_TOKEN = 'mNrrbszEi8ZWd3VE4Svp1a2Y88P_9D8jUReL6Napr5YuoNYcsiqi8NI0QVTbGSuL'
...
// fetch("https://my.callofduty.com/api/papi-client/crm/cod/v2/title/mw/platform/psn/gamer/destrozapanchos2/matches/mp/start/0/end/0/details", requestOptions)
//   .then(response => response.text())
//   .then(result => console.log(result))
//   .catch(error => console.log('error', error));

fetch("https://my.callofduty.com/api/papi-client/stats/cod/v1/title/mw/platform/psn/gamer/destrozapanchos2/profile/friends/type/mp", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
